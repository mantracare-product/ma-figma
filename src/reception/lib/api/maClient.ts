 ...
 *
 * Single Contract Interface between AI Receptionist surface and MantraAssist.
...
export interface IMaClient {
  ...
  // Voice & Knowledge Base Extensions
  ...
  getVisitSummary(clientId: string, appointmentId?: string): Promise<VisitSummary>;
