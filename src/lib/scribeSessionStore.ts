...
export const INITIAL_SCRIBE_SESSIONS: ScribeSession[] = [
  ...
  },
  {
    ...
    transcript: {
      fullText: `[00:00] Doctor: Hello Pooja, how are your eyes 1 month post-LASIK?
...
[00:32] Doctor: Follow the 20-20-20 rule. Next routine check in 3 months on November 24th.`,
      utterances: [
        { id: "u1", speaker: "doctor", startTime: 0, endTime: 5, text: "Hello Pooja, how are your eyes 1 month post-LASIK?", confidence: 0.99 },
  ...
  },
  {
    ...
    transcript: {
      fullText: `[00:00] Doctor: Good morning Mrs. Meena. How has your blood pressure been logging at home?
...
[00:35] Doctor: Yes, strict DASH diet with < 2.5g sodium per day and 30 minutes brisk walking. Next lipid profile and serum potassium in 3 months.`,
      utterances: [
        { id: "u1", speaker: "doctor", startTime: 0, endTime: 6, text: "Good morning Mrs. Meena. How has your blood pressure been logging at home?", confidence: 0.99 },
